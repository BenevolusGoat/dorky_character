...
addCostumeToIgnoreList = {} --No Costumes Mod
Martha = {}
...
---@class EpiphanyCharacterStats
---@field DAMAGE_FLAT number?
---@field DAMAGE_ADD number?
---@field DAMAGE_MULTI number?
---@field FIRERATE_MULTI number?
---@field SHOTSPEED_ADD number?
---@field TEARHEIGHT number?
---@field TEAR_RANGE number?
---@field SPEED_ADD number?
---@field LUCK number?
---@field FLYING boolean?
---@field TEAR_FLAGS TearFlags?
---@field TEAR_COLOR Color?
---@field LASER_COLOR Color?
---@field HEALTH_RED integer?
---@field HEALTH_RED_EXTRA integer?
---@field HEALTH_SOUL integer?
---@field HEALTH_BLACK integer?
---@field HEALTH_ROTTEN integer?
---@field HEALTH_BONE integer?
---@field HEALTH_ETERNAL integer?
---@field HEALTH_BROKEN integer?
---@field COINS integer?
---@field BOMBS integer?
---@field KEYS integer?
---@field ITEMS CollectibleType[]?

---@class EpiphanyAPICharacterInfo
---@field charName string
---@field charID PlayerType
---@field charStats EpiphanyCharacterStats?
---@field costume string @Anm2 path. A copy of the default player anm2 with your character's spritesheet
---@field extraCostume integer[]?
---@field hitSound SoundEffect?
---@field deathSound SoundEffect?
---@field menuGraphics string @Anm2 path. Requires animations "Portrait", "Door" and "Text". See `gfx/ui/epiphany_menu.anm2` for reference
---@field coopMenuSprite string @Anm2 path. Requires animation "Main"
---@field pocketItem CollectibleType?
---@field pocketItemPersistent boolean?
---@field unlockChecker nil | fun(): boolean
---@field floorTutorial string?

---@param charInfo EpiphanyAPICharacterInfo
function Epiphany.API.AddCharacter(charInfo)
end
